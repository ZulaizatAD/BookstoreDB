      ...
      <div className="p-6 space-y-4">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            ...
            <div className="relative">
              <select
                ...
                className="filter-select py-2 text-sm filter-focus appearance-none pr-8"
              >
              ...
              <ChevronDownIcon className="h-4 w-4 absolute right-2 top-1/2 transform -translate-y-1/2 text-cadetblue pointer-events-none" />
            </div>
            ...
            {/* Advanced Filters Toggle - Fixed alignment */}
            <button
        ...
        <div className="border-t border-light-steel-blue pt-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-sm font-medium text-slate-gray">Sort by:</span>
          </div>
          ...
          <div className="border-t border-light-steel-blue pt-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-gray-500">
                {((filteredBooks / totalBooks) * 100).toFixed(1)}% of books shown
              </span>
            </div>
          </div>
        )}
